...
def process_sequences(sequences, min_non_align=0, amplicon_width=0, max_misalign=-1, search_window=50):
    '''
    ...
    for sequence in sequences:
        ...
        if amplicon_width > 0 and max_misalign >= 0:
            if sequence_index == 0:
                feasible_amplicons = find_feasible_amplicons(sequence, lb, ub, amplicon_width, max_misalign, search_window)
            else:
                feasible_amplicons = feasible_amplicons.intersection(find_feasible_amplicons(sequence, lb, ub, amplicon_width, max_misalign, search_window))
        sequence_index += 1
